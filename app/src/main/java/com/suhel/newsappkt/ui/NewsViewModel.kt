...
import com.suhel.newsappkt.models.NewsResponse
import com.suhel.newsappkt.repository.NewsRepository
import com.suhel.newsappkt.util.Resource
...
class NewsViewModel(app: Application,val newsRepository: NewsRepository):AndroidViewModel(app) {
    ...
    private fun handelHeadlnesResponse(response: Response<NewsResponse>):Resource<NewsResponse>{
    ...
    private fun handelSerachNewsResponse(response: Response<NewsResponse>):Resource<NewsResponse> {
        if (response.isSuccessful) {
            response.body()?.let { resultResponse ->
    ...
    private suspend fun headlinesInternet(countryCode: String){
        ...
        try {
            if (internetConnection(this.getApplication())){
                ...
                headlines.postValue(handelHeadlnesResponse(response))
            }else{
    ...
    private suspend fun searchNewsInternet(searchQuery: String){
        ...
        try {
            if (internetConnection(this.getApplication())){
                ...
                searchNews.postValue(handelSerachNewsResponse(response))
            }else{
